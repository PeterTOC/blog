...
author: "Peter Boshe"
date: "2021-12-03"
categories: ["Unguided Project", "Data Mining", "Web Scraping", "R-programming"]
code-fold: true
...
Below is sample script in R for a recent webscraping project I did recently using the principles above toobtain the data to create [this dashboard.](https://petertoc.github.io/flexdashboard/) hosted on github pages.
